...
\\[\blanklineskip]%
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bc}\;\Varid{b}){}\<[23]%
\>[23]{}\mathrel{=}i_1\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bcs}\;\Varid{b})\mathrel{=}i_2\;\Varid{b}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recBlockchain}\;\Varid{f}\mathrel{=}{}\<[20]%
\>[20]{}(\Varid{id}+(\Varid{id}\times\Varid{f})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataBlockchain}\;\Varid{f}\mathrel{=}\Varid{f}\comp (\Varid{recBlockchain}\;(\Varid{cataBlockchain}\;\Varid{f}))\comp \Varid{outBlockchain}{}\<[E]%
\\[\blanklineskip]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ledger}\mathrel{=}\Varid{groupTransactions}\comp \Varid{groupBy}\;(\lambda (e_1 ,\anonymous )\;(e_2 ,\anonymous )\to e_1 \equiv e_2 )\comp \Varid{sort}\comp \Varid{splitTransactions}\comp \Varid{allTransactions}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{splitTransactions}\mathrel{=}\Varid{cataList}\mathbin{\$}\alt{\Varid{nil}}{\Varid{cons}\comp \conj{\conj{e_1 }{\Varid{v}}}{\Varid{cons}\comp \conj{\conj{e_2 }{\Varid{negate}\comp \Varid{v}}}{\p2}}}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{where}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}e_1 \mathrel{=}\p2\comp \p2\comp \p1{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}e_2 \mathrel{=}\p1\comp \p1{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{v}\mathrel{=}\p1\comp \p2\comp \p1{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{groupTransactions}\mathrel{=}\map \;\conj{\p1\comp \Varid{head}}{\Varid{sum}\comp \map \;\p2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\Varid{isSingle}\comp \Varid{group}\comp \Varid{sort}\comp \Varid{getMagicNrs}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{getMagicNrs}\mathrel{=}\Varid{cataBlockchain}\mathbin{\$}\alt{\Varid{singl}\comp \p1}{\Varid{cons}\comp (\p1\times\Varid{id})}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{isSingle}\mathrel{=}\Varid{all}\;((\mathrm{1}\equiv )\comp \length ){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inQTree}\mathrel{=}\alt{\Varid{uncurry2}\;\Conid{Cell}}{\Varid{uncurry3}\;\Conid{Block}}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mathbf{where}\;\Varid{uncurry3}\;\Varid{f}\mathrel{=}\lambda (\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\to \Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\
\>[13]{}\hsindent{6}{}\<[19]%
\>[19]{}\Varid{uncurry2}\;\Varid{f}\mathrel{=}\lambda (\Varid{x},(\Varid{y},\Varid{z}))\to \Varid{f}\;\Varid{x}\;\Varid{y}\;\Varid{z}{}\<[E]%
\\[\blanklineskip]%
...
\>[16]{}\mathrel{=}(\Varid{f}\times\Varid{id})+(\Varid{g}\times(\Varid{g}\times(\Varid{g}\times\Varid{g}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recQTree}\;\Varid{f}\mathrel{=}\Varid{baseQTree}\;\Varid{id}\;\Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataQTree}\;\Varid{a}\mathrel{=}\Varid{a}\comp (\Varid{recQTree}\;(\Varid{cataQTree}\;\Varid{a}))\comp \Varid{outQTree}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{anaQTree}\;\Varid{f}\mathrel{=}\Varid{inQTree}\comp (\Varid{recQTree}\;(\Varid{anaQTree}\;\Varid{f}))\comp \Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloQTree}\;\Varid{a}\;\Varid{c}\mathrel{=}\Varid{cataQTree}\;\Varid{a}\comp \Varid{anaQTree}\;\Varid{c}{}\<[E]%
\\[\blanklineskip]%
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\mathbin{\$}\alt{\Varid{f}}{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{f}\;(\Varid{k},(\Varid{x},\Varid{y}))\mathrel{=}\Conid{Cell}\;\Varid{k}\;\Varid{y}\;\Varid{x}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}\Conid{Block}\;\Varid{c}\;\Varid{a}\;\Varid{d}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{scaleQTree}\;\Varid{n}\mathrel{=}\Varid{cataQTree}\mathbin{\$}\Varid{inQTree}\comp ((\Varid{id}\times((\Varid{n}\mathbin{*})\times(\Varid{n}\mathbin{*}))+\Varid{id})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{invertQTree}\mathrel{=}\mathsf{fmap}\mathbin{\$}\lambda (\Conid{PixelRGBA8}\;\Varid{r}\;\Varid{g}\;\Varid{b}\;\Varid{a})\to (\Conid{PixelRGBA8}\;(\mathrm{255}\mathbin{-}\Varid{r})\;(\mathrm{255}\mathbin{-}\Varid{g})\;(\mathrm{255}\mathbin{-}\Varid{b})\;\Varid{a}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{17}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{compressQTree}\;\Varid{n}\mathrel{=}\uncurry{(\mathsf{for}\ \Varid{recTree}\ \Varid{compress})}\comp \conj{\Varid{subtract}\;\Varid{n}\comp \Varid{depthQTree}}{\Varid{id}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{recTree}\;\Varid{f}\;\Varid{a}\mathrel{=}\Varid{inQTree}\mathbin{\$}\Varid{recQTree}\;\Varid{f}\;(\Varid{outQTree}\;\Varid{a}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{compress}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{f}}{\Varid{g}}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{where}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{f}\mathrel{=}\Varid{inQTree}\comp i_1{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{g}\;(\Conid{Cell}\;\Varid{a}\;\Varid{xa}\;\Varid{ya},(\Conid{Cell}\;\anonymous \;\Varid{xb}\;\anonymous ,(\Conid{Cell}\;\anonymous \;\anonymous \;\Varid{yc},\Conid{Cell}\;\anonymous \;\anonymous \;\anonymous )))\mathrel{=}\Conid{Cell}\;\Varid{a}\;(\Varid{xa}\mathbin{+}\Varid{xb})\;(\Varid{ya}\mathbin{+}\Varid{yc}){}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{g}\;\Varid{a}\mathrel{=}\Varid{inQTree}\comp i_2\mathbin{\$}\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outlineQTree}\;\Varid{h}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{f}}{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{f}\;(\Varid{k},(\Varid{x},\Varid{y}))\mathrel{=}matrix\;\Varid{y}\;\Varid{x}\;(\lambda (\Varid{b},\Varid{a})\to (\Varid{p2p}\;(\Conid{False},(\Varid{h}\;\Varid{k}))\;(\Varid{b}\equiv \Varid{y}\mathrel{\vee}\Varid{b}\equiv \mathrm{1}\mathrel{\vee}\Varid{a}\equiv \Varid{x}\mathrel{\vee}\Varid{a}\equiv \mathrm{1}))){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{a}{\,\updownarrow\,}\Varid{b}){\,\leftrightarrow\,}(\Varid{c}{\,\updownarrow\,}\Varid{d}){}\<[E]%
\ColumnHook
...
\begin{eqnarray*}
	\start
		\ensuremath{\Varid{s}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\succ \comp \Varid{s}}}
	%
	\just\equiv{ Identidade, Cancelamento-$\times$}
		\ensuremath{\Varid{s}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}\comp \Varid{id}}{\succ \comp \p2\comp \conj{\Varid{g}}{\Varid{s}}}}
	%
	\just\equiv{ Absorção-+ (22) }
		\ensuremath{\Varid{s}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\succ \comp \p2}\comp (\Varid{id}\mathbin{+}\conj{\Varid{g}}{\Varid{s}})}
	%
	\just\equiv{ Functor }
		\ensuremath{\Varid{s}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\succ \comp \p2}\comp \Conid{F}\;\conj{\Varid{g}}{\Varid{s}}}
\end{eqnarray*}

\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\N_0}
           \ar[d]_-{\ensuremath{\Varid{s}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\N_0}
           \ar[d]^{\ensuremath{\Conid{F}\;\conj{\Varid{g}}{\Varid{s}}}}
           \ar[l]_-{\ensuremath{\mathsf{in}}}
\\
     \ensuremath{\N_0}
&
     \ensuremath{\mathrm{1}\mathbin{+}\N_0\mathbin{*}\N_0}
           \ar[l]^-{\ensuremath{\alt{\underline{\mathrm{1}}}{\succ \comp \p2}}}
}
\end{eqnarray*}
...
\begin{eqnarray*}
	\start
		\ensuremath{\Varid{g}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}\comp \conj{\Varid{g}}{\Varid{s}}}}
	%
	\just\equiv{ Identidade }
		\ensuremath{\Varid{g}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}\comp \Varid{id}}{\Varid{mul}\comp \conj{\Varid{g}}{\Varid{s}}}}
	%
	\just\equiv{ Absorção-+ (22) }
...
&
     \ensuremath{\mathrm{1}\mathbin{+}\N_0\mathbin{*}\N_0}
           \ar[l]^-{\ensuremath{\alt{\underline{\mathrm{1}}}{\Varid{mul}}}}
}
\end{eqnarray*}
...
\begin{eqnarray*}
	\start
		        \ensuremath{\begin{lcbr}\Varid{g}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp \Conid{F}\;\conj{\Varid{g}}{\Varid{s}}\\\Varid{s}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\succ \comp \p2}\comp \Conid{F}\;\conj{\Varid{g}}{\Varid{s}}\end{lcbr}}
	%
	...
	\just\equiv{ Lei da Troca (28) }
		\ensuremath{\conj{\Varid{g}}{\Varid{s}}\mathrel{=}\cata{\alt{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\conj{\Varid{mul}}{\succ \comp \p2}}}}
	%
\end{eqnarray*}

\begin{eqnarray*}
	\start
		\ensuremath{\Varid{f}\;\Varid{k}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}\comp \conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}}
	%
	\just\equiv{ Identidade }
		\ensuremath{\Varid{f}\;\Varid{k}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}\comp \Varid{id}}{\Varid{mul}\comp \conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}}
	%
	\just\equiv{ Absorção-+ (22) }
...
\xymatrix@C=2cm{
    \ensuremath{\N_0}
           \ar[d]_-{\ensuremath{\Varid{f}\;\Varid{k}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\N_0}
           \ar[d]^{\ensuremath{\Conid{F}\;\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}}
           \ar[l]_-{\ensuremath{\mathsf{in}}}
\\
     \ensuremath{\N_0}
&
...
\begin{eqnarray*}
	\start
		\ensuremath{\Varid{l}\;\Varid{k}\comp \mathbf{in}\mathrel{=}\alt{\succ \comp \Varid{k}}{\succ \comp \Varid{l}\;\Varid{k}}}
	%
	\just\equiv{ Identidade, Cancelamento-$\times$ }
		\ensuremath{\Varid{l}\;\Varid{k}\comp \mathbf{in}\mathrel{=}\alt{\succ \comp \Varid{k}\comp \Varid{id}}{\succ \comp \p2\comp \conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}}
	%
	\just\equiv{ Absorção-+ (22) }
		\ensuremath{\Varid{l}\;\Varid{k}\comp \mathbf{in}\mathrel{=}\alt{\succ \comp \Varid{k}}{\succ \comp \p2}\comp (\Varid{id}\mathbin{+}\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}})}
	%
	\just\equiv{ Functor }
		\ensuremath{\Varid{l}\;\Varid{k}\comp \mathbf{in}\mathrel{=}\alt{\succ \comp \Varid{k}}{\succ \comp \p2}\comp \Conid{F}\;\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}
	%
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{\N_0}
           \ar[d]_-{\ensuremath{\Varid{l}\;\Varid{k}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\N_0}
           \ar[d]^{\ensuremath{\Conid{F}\;\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}}
           \ar[l]_-{\ensuremath{\mathsf{in}}}
...
&
     \ensuremath{\mathrm{1}\mathbin{+}\N_0\mathbin{*}\N_0}
           \ar[l]^-{\ensuremath{\alt{\succ \comp \Varid{k}}{\succ \comp \p2}}}
}
\end{eqnarray*}

\begin{eqnarray*}
	\start
		        \ensuremath{\begin{lcbr}\Varid{f}\;\Varid{k}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp \Conid{F}\;\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\\\Varid{l}\;\Varid{k}\comp \mathbf{in}\mathrel{=}\alt{\succ \comp \Varid{k}}{\succ \comp \p2}\comp \Conid{F}\;\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\end{lcbr}}
	%
	\just\equiv{ Fokkinga (50) }
		\ensuremath{\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\mathrel{=}\cata{\conj{\alt{\underline{\mathrm{1}}}{\Varid{mul}}}{\alt{\succ \comp \Varid{k}}{\succ \comp \p2}}}}
	%
	\just\equiv{ Lei da Troca (28) }
		\ensuremath{\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\mathrel{=}\cata{\alt{\conj{\underline{\mathrm{1}}}{\succ \comp \Varid{k}}}{\conj{\Varid{mul}}{\succ \comp \p2}}}}
	%
\end{eqnarray*}
...
\begin{eqnarray*}
	\start
		\ensuremath{\conj{\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}{\conj{\Varid{g}}{\Varid{s}}}}
	%
	\just\equiv{ Banana-split (51) }
		\ensuremath{\cata{(\alt{\conj{\underline{\mathrm{1}}}{\succ \comp \Varid{k}}}{\conj{\Varid{mul}}{\succ \comp \p2}}\times\alt{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\conj{\Varid{mul}}{\succ \comp \p2}})\comp \conj{\Conid{F}\;\p1}{\Conid{F}\;\p2}}}
	%
	\just\equiv{ Absorção-$\times$ (11) }
		\ensuremath{\cata{\conj{\alt{\conj{\underline{\mathrm{1}}}{\succ \comp \Varid{k}}}{\conj{\Varid{mul}}{\succ \comp \p2}}\comp \Conid{F}\;\p1}{\alt{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\conj{\Varid{mul}}{\succ \comp \p2}}\comp \Conid{F}\;\p2}}}
	%
	\just\equiv{ Functor }
		\ensuremath{\cata{\conj{\alt{\conj{\underline{\mathrm{1}}}{\succ \comp \Varid{k}}}{\conj{\Varid{mul}}{\succ \comp \p2}}\comp (\Varid{id}\mathbin{+}\p1)}{\alt{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\conj{\Varid{mul}}{\succ \comp \p2}}\comp (\Varid{id}\mathbin{+}\p2)}}}
	%
	\just\equiv{ Absorção-+ (22) }
		\ensuremath{\cata{\conj{\alt{\conj{\underline{\mathrm{1}}}{\succ \comp \Varid{k}}}{\conj{\Varid{mul}}{\succ \comp \p2}\comp \p1}}{\alt{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\conj{\Varid{mul}}{\succ \comp \p2}\comp \p2}}}}
	%
	\just\equiv{ Fusão-$\times$ (9) }
		\ensuremath{\cata{\conj{\alt{\conj{\underline{\mathrm{1}}}{\succ \comp \Varid{k}}}{\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}}}{\alt{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}}}}}
	%
	\just\equiv{ Lei da troca (28) }
		\ensuremath{\cata{\alt{\conj{\conj{\underline{\mathrm{1}}}{\succ \comp \Varid{k}}}{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}}{\conj{\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}}}}}
	%
\end{eqnarray*}

\begin{eqnarray*}
	\start
		\ensuremath{\mathsf{for}\ \Varid{g}\ \Varid{i}\mathrel{=}\cata{\alt{\underline{\Varid{i}}}{\Varid{g}}}}
	%
	\just\equiv
		\ensuremath{(\Varid{a},\anonymous ,\Varid{b},\anonymous )\mathrel{=}\cata{\alt{\underline{(\Varid{base}\;\Varid{k})}}{\Varid{loop}}}}
	%
	\just\equiv
			        \ensuremath{\begin{lcbr}\Varid{base}\;\Varid{k}\mathrel{=}\conj{\conj{\underline{\mathrm{1}}}{\succ \comp \Varid{k}}}{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}\\\Varid{loop}\mathrel{=}\conj{\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}}\end{lcbr}}
	%
\end{eqnarray*}
...
\\
\>[B]{}\Varid{loop}\mathrel{=}\Varid{pack}\comp \conj{\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}}\comp \Varid{unpack}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{unpack}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{pack}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{a},\Varid{b},\Varid{c},\Varid{d}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{30}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inFTree}\mathrel{=}\alt{\Conid{Unit}}{\Varid{uncurry2}\;\Conid{Comp}}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mathbf{where}\;\Varid{uncurry2}\;\Varid{f}\mathrel{=}\lambda (\Varid{x},(\Varid{y},\Varid{z}))\to \Varid{f}\;\Varid{x}\;\Varid{y}\;\Varid{z}{}\<[E]%
\\[\blanklineskip]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{generatePTree}\mathrel{=}\Varid{anaFTree}\;\Varid{f}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{f}\;\Varid{n}\mathrel{=}\Varid{p2p}\;(i_2\;(\Varid{r},((\Varid{pred}\;\Varid{n}),(\Varid{pred}\;\Varid{n}))),i_1\;\mathrm{1})\;(\Varid{n}\equiv \mathrm{0}){}\<[E]%
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}\mathbf{where}\;{}\<[13]%
\>[13]{}\Varid{r}\mathrel{=}(\Varid{sqrt}\;\mathrm{2})\mathbin{\uparrow}(\Varid{fromIntegral}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{drawPTree}\mathrel{=}\Varid{cycle}\comp \Varid{reverse}\comp \Varid{aux}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{aux}\;(\Conid{Unit}\;\Varid{a})\mathrel{=}\Varid{singl}\mathbin{\$}\Varid{drawStep}\;(\Conid{Unit}\;\Varid{a}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{aux}\;\Varid{a}\mathrel{=}(\Varid{drawStep}\;\Varid{a})\mathbin{:}\Varid{aux}\;(\Varid{cutLeaves}\;\Varid{a}){}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{where}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{cutLeaves}\mathrel{=}\Varid{cataFTree}\;\alt{\Conid{Unit}}{\Varid{g}}{}\<[E]%
\\
\>[17]{}\hsindent{5}{}\<[22]%
\>[22]{}\mathbf{where}\;\Varid{g}\;(\Varid{s},((\Conid{Unit}\;\anonymous ),(\Conid{Unit}\;\anonymous )))\mathrel{=}\Conid{Unit}\;\Varid{s}{}\<[E]%
\\
\>[22]{}\hsindent{6}{}\<[28]%
\>[28]{}\Varid{g}\;(\Varid{s},(\Varid{l},\Varid{r}))\mathrel{=}\Conid{Comp}\;\Varid{s}\;\Varid{l}\;\Varid{r}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{drawStep}\mathrel{=}\Varid{pictures}\comp \Varid{cataFTree}\;\alt{\Varid{f}}{\Varid{g}}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{where}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{f}\mathrel{=}\Varid{singl}\comp \Varid{square}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{g}\;(\Varid{s},(\Varid{l},\Varid{r}))\mathrel{=}(\Varid{f}\;\Varid{s})\plus \mathsf{conc}\;(\Varid{left}\;\Varid{l},\Varid{right}\;\Varid{r}){}\<[E]%
\\
\>[17]{}\hsindent{4}{}\<[21]%
\>[21]{}\mathbf{where}{}\<[E]%
\\
\>[21]{}\hsindent{4}{}\<[25]%
\>[25]{}\Varid{left}\mathrel{=}{}\<[33]%
\>[33]{}\map \;(\Varid{translate}\;(\mathbin{-}\Varid{s}\mathbin{/}\mathrm{2})\;\Varid{s}\comp \Varid{rotate}\;(\mathbin{-}\mathrm{45})){}\<[E]%
\\
\>[21]{}\hsindent{4}{}\<[25]%
\>[25]{}\Varid{right}\mathrel{=}\map \;(\Varid{translate}\;{}\<[49]%
\>[49]{}(\Varid{s}\mathbin{/}\mathrm{2})\;\Varid{s}\comp \Varid{rotate}\;{}\<[68]%
\>[68]{}\mathrm{45}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{scalePTree}\;\Varid{n}\;(\Conid{Unit}\;\Varid{s})\mathrel{=}\Conid{Unit}\;(\Varid{n}\mathbin{*}\Varid{s}){}\<[E]%
\\
\>[B]{}\Varid{scalePTree}\;\Varid{n}\;(\Conid{Comp}\;\Varid{s}\;\Varid{l}\;\Varid{r})\mathrel{=}\Conid{Comp}\;(\Varid{n}\mathbin{*}\Varid{s})\;(\Varid{scalePTree}\;\Varid{n}\;\Varid{l})\;(\Varid{scalePTree}\;\Varid{n}\;\Varid{r}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{draw}\;\Varid{n}\mathrel{=}\Varid{display}\;\Varid{window}\;\Varid{white}\;(\Varid{n}\mathbin{!!}\mathrm{0}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{main}\mathbin{::}\fun{IO}\;(){}\<[E]%
\\
\>[B]{}\Varid{main}\mathrel{=}\Varid{animatePTree}\;\mathrm{6}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\mu \mathrel{=}{}\<[8]%
\>[8]{}\mathit B\comp \Varid{aux}\comp \Varid{unB}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{aux}\mathrel{=}\Varid{cataList}\mathbin{\$}\alt{\Varid{nil}}{\mathsf{conc}\comp ((\uncurry{\Varid{f}}\comp \Varid{swap}\comp (\Varid{unB}\times\Varid{id}))\times\Varid{id})}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{where}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{f}\;\Varid{n}\mathrel{=}\map \;(\Varid{id}\times(\mathbin{*}\Varid{n})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dist}\mathrel{=}\Varid{uniform}\comp \Varid{concat}\comp \map \;\uncurry{(\Varid{flip}\;\Varid{replicate})}\comp \Varid{unB}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
