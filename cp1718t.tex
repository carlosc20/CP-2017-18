...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment allTransactions (Bc (_, (_, t))) = t}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment allTransactions (Bcs ((_, (_, t)), b)) = t ++ allTransactions b}{}\<[E]%
\\
\>[B]{}\Varid{allTransactions}\mathrel{=}\Varid{cataBlockchain}\mathbin{\$}\alt{\p2\comp \p2}{\uncurry{(\plus )}\comp \conj{\p2\comp \p2\comp \p1}{\p2}}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mbox{\onelinecomment splitTransactions [] = []}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mbox{\onelinecomment splitTransactions ((e1, (v, e2)):t) = (e1, negate v) : (e2, v) : splitTransactions t}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
...
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mbox{\onelinecomment groupTransactions [] = []}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mbox{\onelinecomment groupTransactions (h:t) = (e, sum (snds h)):groupTransactions t}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mbox{\onelinecomment     where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mbox{\onelinecomment         e = fst $ head h}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mbox{\onelinecomment         snds [] = 0}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mbox{\onelinecomment         snds ((a,b):t) = b}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{groupTransactions}\mathrel{=}(\Varid{cataList}\mathbin{\$}\alt{\Varid{nil}}{\Varid{cons}\comp (\conj{\Varid{e}}{\Varid{sum}\comp \Varid{snds}}\times\Varid{id})}){}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{where}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{e}\mathrel{=}\p1\comp \Varid{head}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{snds}\mathrel{=}\Varid{cataList}\mathbin{\$}\alt{\Varid{nil}}{\Varid{cons}\comp (\p2\times\Varid{id})}\mbox{\onelinecomment  Retorna os segundos elementos de uma lista}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\Varid{isSingle}\comp \Varid{group}\comp \Varid{sort}\comp \Varid{getMagicNos}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mbox{\onelinecomment getMagicNos (Bc (n, _)) = [n]}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mbox{\onelinecomment getMagicNos (Bcs ((n,_),b)) = n:getMagicNos b}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{getMagicNos}\mathrel{=}\Varid{cataBlockchain}\mathbin{\$}\alt{\Varid{cons}\comp \conj{\p1}{\Varid{nil}}}{\Varid{cons}\comp (\p1\times\Varid{id})}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mbox{\onelinecomment isSingle [] = True}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mbox{\onelinecomment isSingle (h:t) = (length h == 1) && isSingle t}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{isSingle}\mathrel{=}\Varid{cataList}\mathbin{\$}\alt{\underline{\Conid{True}}}{\uncurry{(\mathrel{\wedge})}\comp ((\uncurry{(\equiv )}\comp \conj{\length }{\underline{\mathrm{1}}})\times\Varid{id})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment inQTree :: Either (a, (Int, Int)) (QTree a, (QTree a, (QTree a, QTree a))) -> QTree a}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment outQTree :: QTree a -> Either (a, (Int, Int)) (QTree a, (QTree a, (QTree a, QTree a)))}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment baseQTree :: (a1 -> b) -> (a2 -> d1) -> Either (a1, d2) (a2, (a2, (a2, a2))) -> Either (b, d2) (d1, (d1, (d1, d1)))}{}\<[E]%
\\
\>[B]{}\Varid{baseQTree}\;\Varid{f}\;\Varid{g}{}\<[16]%
\>[16]{}\mathrel{=}(\Varid{f}\times\Varid{id})+(\Varid{g}\times(\Varid{g}\times(\Varid{g}\times\Varid{g}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment recQTree :: (a -> d1) -> Either (b, d2) (a, (a, (a, a))) -> Either (b, d2) (d1, (d1, (d1, d1)))}{}\<[E]%
\\
\>[B]{}\Varid{recQTree}\;\Varid{f}\mathrel{=}\Varid{baseQTree}\;\Varid{id}\;\Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment cataQTree :: (Either (b, (Int, Int)) (d, (d, (d, d))) -> d) -> QTree b -> d}{}\<[E]%
\\
\>[B]{}\Varid{cataQTree}\;\Varid{a}\mathrel{=}\Varid{a}\comp (\Varid{recQTree}\;(\Varid{cataQTree}\;\Varid{a}))\comp \Varid{outQTree}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment anaQTree :: (a1 -> Either (a2, (Int, Int)) (a1, (a1, (a1, a1)))) -> a1 -> QTree a2}{}\<[E]%
\\
\>[B]{}\Varid{anaQTree}\;\Varid{f}\mathrel{=}\Varid{inQTree}\comp (\Varid{recQTree}\;(\Varid{anaQTree}\;\Varid{f}))\comp \Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment hyloQTree :: (Either (b, (Int, Int)) (c, (c, (c, c))) -> c) -> (a -> Either (b, (Int, Int)) (a, (a, (a, a)))) -> a -> c}{}\<[E]%
\\
...
\\
\>[B]{}\mbox{\onelinecomment rotateQTree :: QTree a -> QTree a}{}\<[E]%
\\
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{f}}{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment scaleQTree :: Int -> QTree a -> QTree a}{}\<[E]%
\\
\>[B]{}\Varid{scaleQTree}\;\Varid{n}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{f}}{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{f}\;(\Varid{k},(\Varid{x},\Varid{y}))\mathrel{=}\Conid{Cell}\;\Varid{k}\;(\Varid{x}\mathbin{*}\Varid{n})\;(\Varid{y}\mathbin{*}\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment invertQTree :: QTree PixelRGBA8 -> QTree PixelRGBA8}{}\<[E]%
\\
\>[B]{}\Varid{invertQTree}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{f}}{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{f}\;((\Conid{PixelRGBA8}\;\Varid{r}\;\Varid{g}\;\Varid{b}\;\Varid{a}),(\Varid{x},\Varid{y}))\mathrel{=}\Conid{Cell}\;(\Conid{PixelRGBA8}\;(\mathrm{255}\mathbin{-}\Varid{r})\;(\mathrm{255}\mathbin{-}\Varid{g})\;(\mathrm{255}\mathbin{-}\Varid{b})\;\Varid{a})\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment 2     NAO FUNCIONA usar o n}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment compressQTree :: Int -> QTree a -> QTree a}{}\<[E]%
\\
\>[B]{}\Varid{compressQTree}\;\Varid{n}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{f}}{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{f}\;(\Varid{k},(\Varid{x},\Varid{y}))\mathrel{=}\Conid{Cell}\;\Varid{k}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g}\;(\Conid{Cell}\;\Varid{a}\;\Varid{xa}\;\Varid{ya},(\Conid{Cell}\;\Varid{b}\;\Varid{xb}\;\Varid{yb},(\Conid{Cell}\;\Varid{c}\;\Varid{xc}\;\Varid{yc},\Conid{Cell}\;\Varid{d}\;\Varid{xd}\;\Varid{yd})))\mathrel{=}\Conid{Cell}\;\Varid{a}\;(\Varid{xa}\mathbin{+}\Varid{xb}\mathbin{+}\Varid{xc}\mathbin{+}\Varid{xd})\;(\Varid{ya}\mathbin{+}\Varid{yb}\mathbin{+}\Varid{yc}\mathbin{+}\Varid{yd}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment compressBMP 1 "cp1718t_media/person.bmp" "person1.bmp"}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment compressBMP 2 "cp1718t_media/person.bmp" "person2.bmp"}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment compressBMP 3 "cp1718t_media/person.bmp" "person3.bmp"}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment compressBMP 4 "cp1718t_media/person.bmp" "person4.bmp"}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment 3      }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment outlineQTree :: (a -> Bool ) -> QTree a -> Matrix Bool}{}\<[E]%
\\
\>[B]{}\Varid{outlineQTree}\;\Varid{h}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{f}}{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{f}\;(\Varid{k},(\Varid{x},\Varid{y}))\mathrel{=}matrix\;\Varid{y}\;\Varid{x}\;\underline{(\Varid{h}\;\Varid{k})}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{a}{\,\updownarrow\,}\Varid{b}){\,\leftrightarrow\,}(\Varid{c}{\,\updownarrow\,}\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  <(AQUI COLOCA-SE UMA BARRA VERTICAL)> junta matrizes horizontalmente}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  <-> junta matrizes verticalmente}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment outlineBMP "cp1718t_media/person.bmp" "personOut1.bmp"}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment addOutlineBMP "cp1718t_media/person.bmp" "personOut2.bmp"}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment nao funciona o teste2a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{30}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment data FTree a b = Unit b (AQUI COLOCA-SE UMA BARRA VERTICAL) Comp a (FTree a b) (FTree a b) deriving (Eq,Show)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment type PTree = FTree Square Square}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment type Square = Float}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment inFTree :: Either b (a, (FTree a b, FTree a b)) -> FTree a b}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment outFTree :: FTree a1 a2 -> Either a2 (a1, (FTree a1 a2, FTree a1 a2))}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment invFTree = cataFTree (inFTree . (id -(AQUI COLOCA-SE UMA BARRA VERTICAL)- id >< swap))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment countFTree = cataFTree (either (const 1) (succ . (uncurry (+)) . p2))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment generatePTree :: Int -> PTree  }{}\<[E]%
\\
\>[B]{}\Varid{generatePTree}\mathrel{=}\Varid{anaFTree}\;\Varid{f}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{f}\;\Varid{n}\mathrel{=}\mathbf{if}\;(\Varid{n}\equiv \mathrm{0})\;\mathbf{then}\;i_1\;\mathrm{1}\;\mathbf{else}\;i_2\;(\Varid{r},((\Varid{n}\mathbin{-}\mathrm{1}),(\Varid{n}\mathbin{-}\mathrm{1}))){}\<[E]%
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}\mathbf{where}\;{}\<[13]%
\>[13]{}\Varid{r}\mathrel{=}(\Varid{sqrt}\;\mathrm{2})\mathbin{\uparrow}(\Varid{fromIntegral}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment drawPTree :: PTree -> [Picture] cata e/ou ana}{}\<[E]%
\\
\>[B]{}\Varid{drawPTree}\mathrel{=}\Varid{cataFTree}\;\alt{\Varid{f}}{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{f}\;\Varid{s}\mathrel{=}[\mskip1.5mu \Varid{makeSquare}\;\Varid{s}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g}\;(\Varid{s},(\p1,\p2))\mathrel{=}[\mskip1.5mu \Varid{makeSquare}\;\Varid{s}\mskip1.5mu]\plus \p1\plus \p2{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{makeSquare}\mathbin{::}\Conid{Square}\to \Conid{Picture}{}\<[E]%
\\
\>[B]{}\Varid{makeSquare}\;\Varid{s}\mathrel{=}\Varid{square1}\;(\Varid{centerS}\;\Varid{s})\;\Varid{s}\;(\Varid{rotateS}\;\Varid{s}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{square1}\mathbin{::}\Conid{Point}\to \Conid{Square}\to \Conid{Bool}\to \Conid{Picture}{}\<[E]%
\\
\>[B]{}\Varid{square1}\;(\Varid{x},\Varid{y})\;\Varid{l}\;\Conid{True}\mathrel{=}\Varid{translate}\;\Varid{x}\;\Varid{y}\mathbin{\$}\Varid{rectangleSolid}\;\Varid{l}\;\Varid{l}{}\<[E]%
\\
\>[B]{}\Varid{square1}\;(\Varid{x},\Varid{y})\;\Varid{l}\;\Conid{False}\mathrel{=}\Varid{rotate}\;\mathrm{90}\mathbin{\$}\Varid{translate}\;\Varid{x}\;\Varid{y}\mathbin{\$}\Varid{rectangleSolid}\;\Varid{l}\;\Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rotateS}\mathbin{::}\Conid{Square}\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{rotateS}\;\anonymous \mathrel{=}\Conid{True}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{centerS}\mathbin{::}\Conid{Square}\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[B]{}\Varid{centerS}\;\anonymous \mathrel{=}(\mathrm{0},\mathrm{0}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin 
...
drawPTree = anaFTree drawSquare \commentend}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
singletonbag = B . groupBag . groupBy (\(e1, _) (e2, _) -> e1 == e2) . sort . cons . split (split id (const 1)) nil
    where
        groupBag = (cataList $ either nil (cons . (split e (sum . snds) >< id)))
            where
                e = p1 . head
                snds = cataList $ either nil (cons . (p2 >< id)) -- Retorna os segundos elementos de uma lista \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{singletonbag}\mathrel{=}\mathit B\comp \Varid{cons}\comp \conj{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\Varid{nil}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mu \mathrel{=}\mathit B\comp \Varid{aux}\comp \Varid{unBag}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{unBag}\;(\mathit B\;\Varid{a})\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{aux}\mathrel{=}\Varid{cataList}\mathbin{\$}\alt{\Varid{nil}}{\uncurry{(\plus )}\comp ((\uncurry{\Varid{f}}\comp \Varid{swap}\comp \Varid{unBag2})\times\Varid{id})}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{where}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{unBag2}\;(\mathit B\;\Varid{a},\Varid{b})\mathrel{=}(\Varid{a},\Varid{b}){}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{f}\;\Varid{n}\mathrel{=}\Varid{cataList}\mathbin{\$}\alt{\Varid{nil}}{\Varid{cons}\comp ((\Varid{id}\times(\mathbin{*}\Varid{n}))\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dist}\mathrel{=}\Conid{D}\comp \uncurry{\Varid{aux}}\comp \conj{\Varid{fromIntegral}\comp \length }{\Varid{id}}\comp \Varid{unBag}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
...
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{aux}\;\Varid{n}\mathrel{=}\Varid{cataList}\mathbin{\$}\alt{\Varid{nil}}{\Varid{cons}\comp ((\Varid{id}\times(\uncurry{(\mathbin{/})}\comp \conj{\Varid{fromIntegral}}{\underline{\Varid{n}}}))\times\Varid{id})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
