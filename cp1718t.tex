...
\column{17}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{compressQTree}\;\Varid{n}\mathrel{=}\uncurry{(\mathsf{for}\ \Varid{recTree}\ \Varid{compress})}\comp \conj{\uncurry{\Varid{max}}\comp \conj{\Varid{subtract}\;\Varid{n}\comp \Varid{depthQTree}}{\underline{\mathrm{0}}}}{\Varid{id}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{recTree}\;\Varid{f}\mathrel{=}\Varid{inQTree}\comp (\Varid{recQTree}\;\Varid{f})\comp \Varid{outQTree}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{f}\;\Varid{n}\mathrel{=}\Varid{p2p}\;(i_2\;(\Varid{r},((\Varid{pred}\;\Varid{n}),(\Varid{pred}\;\Varid{n}))),i_1\;\mathrm{20})\;(\Varid{n}\equiv \mathrm{0}){}\<[E]%
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}\mathbf{where}\;{}\<[13]%
\>[13]{}\Varid{r}\mathrel{=}(\Varid{sqrt}\;\mathrm{2})\mathbin{\uparrow}(\Varid{fromIntegral}\;\Varid{n})\mathbin{*}\mathrm{20}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{cutLeaves}\;(\Conid{Unit}\;\Varid{s})\mathrel{=}\Conid{Unit}\;\Varid{s}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{cutLeaves}\;(\Conid{Comp}\;\Varid{s}\;(\Conid{Unit}\;\anonymous )\;(\Conid{Unit}\;\anonymous ))\mathrel{=}\Conid{Unit}\;\Varid{s}{}\<[E]%
\\
\>[13]{}\hsindent{4}{}\<[17]%
\>[17]{}\Varid{cutLeaves}\;(\Conid{Comp}\;\Varid{s}\;\Varid{l}\;\Varid{r})\mathrel{=}\Conid{Comp}\;\Varid{s}\;(\Varid{cutLeaves}\;\Varid{l})\;(\Varid{cutLeaves}\;\Varid{r}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
